                    ...
                    <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                      ...
                      <div class="sm:col-span-8 lg:col-span-7">
                        ...
                        <section aria-labelledby="information-heading" class="mt-2">
                          ...
                          <p class="mt-2 text-gray-500">
                            Movement: {{ selectedProduct.attribute.movement }}
                          </p>
                          <p class="mt-2 text-gray-500">
                            Case: {{ selectedProduct.attribute.case }}
                          </p>
                          <p class="mt-2 text-gray-500">
                            Dây đeo: {{ selectedProduct.attribute.strap }}
                          </p>
                          <p class="mt-2 text-gray-500">
                            Water Resistance:
                            {{ selectedProduct.attribute.water_resistance }}
                          </p>
                          <p class="mt-2 text-gray-500">
...
import { onMounted, ref, h, inject, computed, provide, reactive } from "vue";
